...
screen hachimi_extra_cg_kohana_2():
    tag menu
    modal True
    ...
    grid 4 4:
        ...
        spacing 20
        imagebutton:
            idle bordered_image("images/cg/hv/tmb_hv705.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/hv/tmb_hv705.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="kohana_17")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="kohana_18")]
        imagebutton:
            idle bordered_image("images/cg/hv/tmb_hv707.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/hv/tmb_hv707.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="kohana_19")]
