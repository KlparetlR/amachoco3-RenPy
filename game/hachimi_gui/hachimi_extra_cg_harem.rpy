screen hachimi_extra_cg_harem():
    ...
    grid 4 4:
        ...
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="haremu_01")]
        imagebutton:
            idle bordered_image("images/cg/hv/tmb_hv006.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/hv/tmb_hv006.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="haremu_02")]
    ...
    vbox:
        ...
        imagebutton:
            idle "gui/hachimi_gui/extra/extra_harem_2.png"