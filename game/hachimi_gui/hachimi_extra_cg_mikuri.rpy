screen hachimi_extra_cg_mikuri():
    tag menu
    modal True
    ...
    grid 4 4:
        ...
        spacing 20
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev113.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev113.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mikuri_01")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mikuri_02")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mikuri_03")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mikuri_04")]
    ...
    vbox:
        ...
        spacing 20
        imagebutton:
            idle "gui/hachimi_gui/extra/extra_mikuri_2.png"
        imagebutton:
