screen hachimi_about_update_2():
    tag menu
    add "gui/hachimi_gui/about/about_update_bg_2.png"
    ...
    hbox:
        ...
        imagebutton:
            idle "gui/hachimi_gui/extra/extra_page3_1.png" at Transform(zoom=1.1)
            hover "gui/hachimi_gui/extra/extra_page3_2.png"
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),ShowMenu("hachimi_about_update_3")]