...
screen hachimi_extra_cg_mitsuki_1():
    tag menu
    modal True
    ...
    grid 4 4:
        ...
        spacing 20
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev601.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev601.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_01")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev602.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev602.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_02")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev603.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev603.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_03")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev604.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev604.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_04")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev605.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev605.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_05")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev606.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev606.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_06")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev607.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev607.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_07")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev608.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev608.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_08")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev609.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev609.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_09")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev610.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev610.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_10")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev611.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev611.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_11")]
        imagebutton:
            idle bordered_image("images/cg/ev/tmb_ev612.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/ev/tmb_ev612.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_12")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_13")]
        imagebutton:
            idle bordered_image("images/cg/hv/tmb_hv602.webp", white=2, black=2, size=(370,208))
            hover white_overlay("images/cg/hv/tmb_hv602.webp", 0.3, 370, 208, border=True, white=2, black=2)
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_14")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_15")]
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),With(Dissolve(0.3)),Show("cg_viewer", group="mitsuki_16")]
    ...
    hbox:
        ...
        imagebutton:
            ...
            hovered Play("sys_sound_1","gui/hachimi_gui/sound/sys_sound_1.ogg")
            action [Play("sys_sound_2","gui/hachimi_gui/sound/sys_sound_2.ogg"),ShowMenu("hachimi_extra_cg_mitsuki_2")]